...
<a id="russian"></a>
## 🛡️ Безопасность
- 🔒 Все передаваемые данные шифруются (RSA-2048)
...
## Внимание
Если проверяете игроков в компьютерных клубах, то учитывайте что проверку с одного IP адреса можно запускать только через три минуты после предыдущего. (Иначе сработает защита)
